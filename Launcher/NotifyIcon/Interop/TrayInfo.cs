...
namespace Launcher.NotifyIcon.Interop
{
    ...
    public static class TrayInfo
    {
        ...
        {
            int space = 2;
            var info = new Launcher.NotifyIcon.Interop.AppBarInfo();
            ...
            switch (info.Edge)
            {
                case Launcher.NotifyIcon.Interop.AppBarInfo.ScreenEdge.Left:
                    x = rcWorkArea.Right + space;
                    y = rcWorkArea.Bottom;
                    break;
                case Launcher.NotifyIcon.Interop.AppBarInfo.ScreenEdge.Bottom:
                    x = rcWorkArea.Right;
                    y = rcWorkArea.Bottom - rcWorkArea.Height - space;
                    break;
                case Launcher.NotifyIcon.Interop.AppBarInfo.ScreenEdge.Top:
                    x = rcWorkArea.Right;
                    y = rcWorkArea.Top + rcWorkArea.Height + space;
                    break;
                case Launcher.NotifyIcon.Interop.AppBarInfo.ScreenEdge.Right:
